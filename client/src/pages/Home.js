    ...
    <Col className="home-container">
      <Row>
        <Col className="home-banner banner-container">
          <h2>Wanna try some new recipe today ? </h2>
          <p>Give a try to selected cusines and join us now!</p>
      ...
      <Col className="home-description">
        ...
        <Row className="description-item-container">
          <Col className="description-item">
            ...
            <Icon.SearchHeart className="searchHeart"/>
            {/* <img src="https://via.placeholder.com/125" alt="palceholder" /> */}
            <p>
              You can find multiple recepies from wide range of delicacis .
            </p>
          </Col>
          <Col className="description-item">
            <h4>Save Recipes</h4>
            <Icon.Save2 className="icon-Save2"/>
            {/* <img src="https://via.placeholder.com/125 " alt="palceholder" /> */}
            <p>
          ...
          <Col className="description-item">
            ...
            <Icon.Globe2 className="icon-Globe2"/>
